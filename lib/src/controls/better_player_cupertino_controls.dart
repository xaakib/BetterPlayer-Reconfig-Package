...
class _BetterPlayerCupertinoControlsState
  ...
  bool isVisibilityBack = false;
  late Timer getSetTimer;
  late Timer getstatecheBackTImer;
  @override
  void initState() {
    getStatchane();
    getStatchaneBack();
  ...
  void getStatchane() {
    ...
    getSetTimer = Timer(Duration(seconds: 1), () {
      print("Future delayed runing");
      setState(() {
        isVisibility = !isVisibility;
        print("Future delayed runing sestate");
        getStatchane();
      });
    });
    setState(() {
  ...
  Widget build(BuildContext context) {
    //  print("_latestValue${_latestValue!.duration}");
